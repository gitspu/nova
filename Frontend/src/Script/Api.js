...
import * as toProfileEm from './Api/ProfileEmployer'
...
export const profileEm = toProfileEm;
...
export async function init ()
{
    ...
    if (!profileOf.isInit()) 
        await profileOf.init ();

    if (!profileEm.isInit ()) 
        await profileEm.init ();
...
{
    if (value == "" || value == null)
        return toIcon.default.transparent;
